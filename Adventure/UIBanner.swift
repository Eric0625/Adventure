...
open class UIBanner: UIView {
    ...
    public convenience init(title: String? = nil, subtitle: String? = nil, image: UIImage? = nil, backgroundColor: UIColor = UIColor.black, didTapBlock: (() -> ())? = nil) {
        var str = ""
        if subtitle != nil { str = subtitle! }
        self.init(title: title, asubtitle: processFormattedString(str), image: image, backgroundColor: backgroundColor, didTapBlock: didTapBlock)
    }
    
    init(title: String? = nil, asubtitle: NSAttributedString? = nil, image: UIImage? = nil, backgroundColor: UIColor = UIColor.black, didTapBlock: (() -> ())? = nil) {
        ...
        detailLabel.attributedText = asubtitle
    ...
    private func addGestureRecognizers() {
        addGestureRecognizer(UITapGestureRecognizer(target: self, action:  #selector(UIBanner.didTap(_:))))
        let swipe = UISwipeGestureRecognizer(target: self, action: #selector(UIBanner.didSwipe(_:)))
        swipe.direction = .up
    ...
    private func adjustHeightOffset() {
        ...
        if superview === UIBanner.topWindow() && self.position == .top {
    ...
    open func show(_ view: UIView? = UIBanner.topWindow(), duration: TimeInterval? = nil) {
