...
struct ItemCommands {
    ...
    static let get = "拾取"
    static let stole = "偷窃"
    static let harving = "采集"
    static let equip = "装备"
    static let unequip = "卸载"
    static let drop = "丢弃"
    static let getAll = "拿取全部"
    static let normalCmds = [observe]
//    
//    var chineseStrings: [String] {
//        switch self {
...
enum Directions
{
    ...
    static func < (left: Directions, right: Directions) -> Bool {
